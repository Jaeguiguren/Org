...
function App() {
  ...
  const actualizarColor = (color,id)=>{
    console.log('El color es: ', color, id)
  ...
  const nuevoEquipo = (crearEquipo)=>{
    ...
    actualizarEquipo([...equipos,{...crearEquipo, id: uuid()}])
  }

  const like = (id)=>{
    console.log('like', id)
    const likedTeam  = colaboradores.map((colaborador)=>{
    ...
    actualizarColaboradores(likedTeam)
  }
